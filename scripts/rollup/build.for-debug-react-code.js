const $$addPathInfoAnnotationForEachFilePlugin = require('../../debug/rollup-plugin-add-path-info-annoation-for-each-file.js');
'use strict';
...
async function createBundle(bundle, bundleType) {
  ...
  if (isWatchMode) {
    ...
    console.log(`${chalk.bgYellow.black(' BUILDING ')} ${logKey}`);
    try {
rollupConfig.plugins.push($$addPathInfoAnnotationForEachFilePlugin('D:/Code/react'));
